...
date: 2020-03-13
description: A setup with Typescript, Eslint and Prettier.
published: true
---

### **Start your new react project.**

###### A setup with Typescript, Eslint and Prettier.
...
1. ##### Let's start with webpack and babel setup.
...
2. ##### Typescript and react.
   ...
   **@types/react y @types/react-dom:** These packages add the types to react and react-dom.
...
3. ##### Better development experience with Eslint and Prettier.
